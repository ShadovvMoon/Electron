...
void main(void) {
    ...
    for (int i = 0; i < mapCount; i++) {
        ...
        int cF = colorFunction[i];
        int aF = alphaFunction[i];
        if (cF == 0) {
            cF = prevColour; // current
        }
        if (aF == 0) {
            aF = prevAlpha; // current
        }
        ...
        if (aF == 0) {
            ...
            colour.a *= tex.r; // multiply
        } else if (aF == 3) {
            colour.a = colour.a * tex.a * tex.a; // double multiply
        } else if (aF == 4) {
            colour.a += tex.a; // add
        } else if (aF == 7) {
            colour.a -= tex.a; // subtract current
        } else if (aF == 9) {
